...
<title>會員資料修改 - update_generalmember_input.jsp</title>
...
<table id="table-1">
	<tr><td>
		 <h3>會員資料修改 - update_generalmember_input.jsp</h3>
...
<table>
	...
	<tr>
		<td>會員照片:</td>
		<td><input type="image" name="photo" size="45" value="<%=gmVO.getPhoto()%>" /></td>
	</tr>
	<tr>
		<td>會員簡介:</td>
		<td><input type="TEXT" name="commment" size="45" value="<%=gmVO.getComment()%>" /></td>
	</tr>
