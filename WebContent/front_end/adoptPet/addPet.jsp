...
<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/adoptPet/addPet.do" name="newPet">
	...
	<input type="hidden" name="adopt_pet_state" value="0"> <input
		type="hidden" name="action" value="addPet">
