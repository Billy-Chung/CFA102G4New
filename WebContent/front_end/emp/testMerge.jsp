...
-->
    ...
    <link rel="stylesheet" href="../front_CSS/assets/css/vendor/vendor.min.css">
    <link rel="stylesheet" href="../front_CSS/assets/css/plugins/plugins.min.css">
...
<body>
            ...
            <div class="swiper-wrapper">
                ...
                <div class="hero-slide-item swiper-slide">
                    <div class="hero-slide-bg">
                        <img src="../front_CSS/assets/images/slider/slider1-1.png" alt="Slider Image" />
                    </div>
                    <div class="container">
                ...
                <div class="hero-slide-item swiper-slide">
                    <div class="hero-slide-bg">
                        <img src="../front_CSS/assets/images/slider/slider1-2.png" alt="Slider Image" />
                    </div>
                    <div class="container">
            ...
            <div class="row row-cols-md-3 row-cols-sm-2 row-cols-1 m-b-n30">
                ...
                <div class="col m-b-30" data-aos="fade-up" data-aos-duration="1000">
                    <a href="shop.html" class="banner hover-style">
                        <img class="fit-image" src="../front_CSS/assets/images/banner/3.png" alt="Banner Image" />
                    </a>
                </div>
                <!-- Banner End -->

                <!-- Banner Start -->
                <div class="col m-b-30" data-aos="fade-up" data-aos-duration="1300">
                    <a href="shop.html" class="banner hover-style">
                        <img class="fit-image" src="../front_CSS/assets/images/banner/4.png" alt="Banner Image" />
                    </a>
                </div>
                <!-- Banner End -->

                <!-- Banner Start -->
                <div class="col m-b-30" data-aos="fade-up" data-aos-duration="1600">
                    <a href="shop.html" class="banner hover-style">
                        <img class="fit-image" src="../front_CSS/assets/images/banner/5.png" alt="Banner Image" />
                    </a>
                </div>
                <!-- Banner End -->
                                    ...
                                    <div class="product">
                                        ...
                                        <div class="thumb">
                                            <a href="single-product.html" class="image">
                                                <img class="fit-image"
                                                    src="../front_CSS/assets/images/products/medium-product/1.png"
                                                    alt="Product" />
                                            </a>
                                            <span class="badges">
                                ...
                                <div class="col-12 col-sm-6 col-lg-3 product-wrapper m-b-40">
                                    <div class="product">
                                        ...
                                        <div class="thumb">
                                            <a href="single-product.html" class="image">
                                                <img class="fit-image"
                                                    src="../front_CSS/assets/images/products/medium-product/3.png"
                                                    alt="Product" />
                                            </a>
                                            <span class="badges">
                                ...
                                <div class="col-12 col-sm-6 col-lg-3 product-wrapper m-b-40">
                                    <div class="product">
                                        ...
                                        <div class="thumb">
                                            <a href="single-product.html" class="image">
                                                <img class="fit-image"
                                                    src="../front_CSS/assets/images/products/medium-product/4.png"
                                                    alt="Product" />
                                            </a>
                                            <div class="action-wrapper">
                                                <a href="#/" class="action quickview" data-bs-toggle="modal"
                                ...
                                <div class="col-12 col-sm-6 col-lg-3 product-wrapper m-b-40">
                                    <div class="product">
                                        ...
                                        <div class="thumb">
                                            <a href="single-product.html" class="image">
                                                <img class="fit-image"
                                                    src="../front_CSS/assets/images/products/medium-product/5.png"
                                                    alt="Product" />
                                            </a>
                                            <span class="badges">
                                                <span class="sale">-18%</span>
                                ...
                                <div class="col-12 col-sm-6 col-lg-3 product-wrapper m-b-40">
                                    <div class="product">
                                        ...
                                        <div class="thumb">
                                            <a href="single-product.html" class="image">
                                                <img class="fit-image"
                                                    src="../front_CSS/assets/images/products/medium-product/6.png"
                                                    alt="Product" />
                                            </a>
                                            <span class="badges">
                                ...
                                <div class="col-12 col-sm-6 col-lg-3 product-wrapper m-b-40">
                                    <div class="product">
                                        ...
                                        <div class="thumb">
                                            <a href="single-product.html" class="image">
                                                <img class="fit-image"
                                                    src="../front_CSS/assets/images/products/medium-product/7.png"
                                                    alt="Product" />
                                            </a>
                                            <span class="badges">
                                                <span class="new">New</span>
                                ...
                                <div class="col-12 col-sm-6 col-lg-3 product-wrapper m-b-40">
                                    <div class="product">
                                        ...
                                        <div class="thumb">
                                            <a href="single-product.html" class="image">
                                                <img class="fit-image"
                                                    src="../front_CSS/assets/images/products/medium-product/8.png"
                                                    alt="Product" />
                                            </a>
                                            <div class="action-wrapper">
                                                <a href="#/" class="action quickview" data-bs-toggle="modal"
                                ...
                                <div class="col-12 col-sm-6 col-lg-3 product-wrapper m-b-40">
                                    <div class="product">
                                        ...
                                        <div class="thumb">
                                            <a href="single-product.html" class="image">
                                                <img class="fit-image"
                                                    src="../front_CSS/assets/images/products/medium-product/2.png"
                                                    alt="Product" />
                                            </a>
                                            <span class="badges">
                                                <span class="sale">-20%</span>
            ...
            <div class="row m-b-n30">
                ...
                <div class="col-md-6 col-12 m-b-30" data-aos="fade-up" data-aos-duration="1000">
                    <a href="shop.html" class="banner">
                        <img class="fit-image" src="../front_CSS/assets/images/banner/6.png" alt="Banner Image" />
                    </a>
                </div>
                <!-- Banner End -->
                ...
                <div class="col-md-6 col-12 m-b-30" data-aos="fade-up" data-aos-duration="1400">
                    <a href="shop.html" class="banner">
                        <img class="fit-image" src="../front_CSS/assets/images/banner/7.png" alt="Banner Image" />
                    </a>
                </div>
                <!-- Banner End -->
                                    ...
                                    <div class="single-deal-product row m-b-n30">
                                        ...
                                        <div class="deal-thumb col-md-6 m-b-30" data-aos="fade-up"
                                            ...
                                            <a href="single-product.html">
                                                <img class="fit-image"
                                                    src="../front_CSS/assets/images/products/large-product/9.png"
                                                    alt="Product Image">
                                            </a>
                                        </div>
                                        <!-- Deal Thumb End -->
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="single-deal-product row m-b-n30">
                                        ...
                                        <div class="deal-thumb col-md-6 m-b-30">
                                            <a href="single-product.html">
                                                <img class="fit-image"
                                                    src="../front_CSS/assets/images/products/large-product/10.png"
                                                    alt="Product Image">
                                            </a>
                                        </div>
                                        <!-- Deal Thumb End -->
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="testimonial-thumb text-center">
                                        <img src="../front_CSS/assets/images/testimonial/1.png" alt="Testimonial Image">
                                ...
                                <div class="swiper-slide">
                                    <!-- Testimonial Thumb Start -->
                                    <div class="testimonial-thumb text-center">
                                        <img src="../front_CSS/assets/images/testimonial/2.png" alt="Testimonial Image">
            ...
            <div class="row row-cols-lg-3 row-cols-sm-2 row-cols-1 m-b-n40">
                    ...
                    <div class="single-blog-wrapper">
                        ...
                        <div class="blog-thumb thumb-effect">
                            <a class="image" href="blog-details.html">
                                <img class="fit-image" src="../front_CSS/assets/images/blog/medium-size/1.jpg"
                                    alt="Blog Image">
                            </a>
                        </div>
                        <!-- Blog Thumb End -->
                ...
                <div class="col m-b-40" data-aos="fade-up" data-aos-duration="1300">
                    ...
                    <div class="single-blog-wrapper">
                        ...
                        <div class="blog-thumb thumb-effect">
                            <a class="image" href="blog-details.html">
                                <img class="fit-image" src="../front_CSS/assets/images/blog/medium-size/2.jpg"
                                    alt="Blog Image">
                            </a>
                        </div>
                        <!-- Blog Thumb End -->
                ...
                <div class="col m-b-40" data-aos="fade-up" data-aos-duration="1600">
                    ...
                    <div class="single-blog-wrapper">
                        ...
                        <div class="blog-thumb thumb-effect">
                            <a class="image" href="blog-details.html">
                                <img class="fit-image" src="../front_CSS/assets/images/blog/medium-size/3.jpg"
                                    alt="Blog Image">
                            </a>
                        </div>
                        <!-- Blog Thumb End -->
   ...
   <%@ include file="../front_page/footer.jsp"%>
                            ...
                            <div class="swiper-container">
                                <div class="swiper-wrapper">
                                    <a class="swiper-slide" href="#">
                                        <img class="w-100" src="../front_CSS/assets/images/products/large-product/1.png"
                                            alt="Product">
                                    </a>
                                    <a class="swiper-slide" href="#">
                                        <img class="w-100" src="../front_CSS/assets/images/products/large-product/2.png"
                                            alt="Product">
                                    </a>
                                    <a class="swiper-slide" href="#">
                                        <img class="w-100" src="../front_CSS/assets/images/products/large-product/3.png"
                                            alt="Product">
                                    </a>
                                    <a class="swiper-slide" href="#">
                                        <img class="w-100" src="../front_CSS/assets/images/products/large-product/4.png"
                                            alt="Product">
                                    </a>
                                    <a class="swiper-slide" href="#">
                                        <img class="w-100" src="../front_CSS/assets/images/products/large-product/5.png"
                                            alt="Product">
                                    </a>
                                </div>
                            ...
                            <div class="payment-option m-t-20 d-flex justify-content-start">
                                ...
                                <a href="#">
                                    <img class="fit-image m-l-5"
                                        src="../front_CSS/assets/images/payment/payment_large.png"
    ...
    <script src="../front_CSS/assets/js/vendor.min.js"></script>
    <script src="../front_CSS/assets/js/plugins.min.js"></script>
