  ...
  <div class="section section-padding bg-name-splashy ">
    <div class="container">
      <div class="row align-items-center m-b-n30 ">
        ...
        <div class="col-12 col-md-6 m-b-30" data-aos="fade-up" data-aos-duration="1400">
          <!-- Newsletter Form Start -->
          <div class="newsletter-form-wrap newsletter-inner">
            <form id="mc-form" class="mc-form">
              <input type="email" id="mc-email" class="form-control email-box" placeholder="demo@example.com"
                name="EMAIL">
