                  ...
                  <div class="header-cart-content">
                    ...
                    <div class="cart-product-wrapper">
                      ...
                      <div class="cart-product-inner p-b-20 m-b-20 border-bottom">
                        ...
                        <div class="single-cart-product">
                          <div class="cart-product-thumb">
                            <a href="single-product.html"><img src="../front_CSS/assets/images/header/header-cart/1.png"
                                alt="Cart Product"></a>
                          </div>
                      ...
                      <div class="cart-product-inner p-b-20 m-b-20 border-bottom">
                        ...
                        <div class="single-cart-product">
                          <div class="cart-product-thumb">
                            <a href="single-product.html"><img src="../front_CSS/assets/images/header/header-cart/2.png"
                                alt="Cart Product"></a>
                          </div>
                          <div class="cart-product-content">
