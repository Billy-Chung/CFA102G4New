...
<title>領養申請新增 - addAdoptApply.jsp</title>
...
<table id="table-1">
	<tr><td>
		 <h3>領養申請新增 - addAdoptApply.jsp</h3></td><td>
		 <h4><a href="select_page.jsp"><img src="  " width="100" height="100" border="0">回首頁</a></h4>
	</td></tr>
</table>
...
<% 
  java.sql.Date adopt_apply_date = null;//宣告
  try {
	   adopt_apply_date = adoptApplyVO.getAdopt_apply_date();//第一次是空值去捕捉今日日期
   } catch (Exception e) {
	   adopt_apply_date = new java.sql.Date(System.currentTimeMillis());//取值
   }
