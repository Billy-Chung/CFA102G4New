...
<div class="card ">
	<img id="isNewPhoto${AdoptPetVO.adopt_pet_no}" class="card-img-top img-fluid imgSize">
	<div class="card-body">
		<FORM action="<%=request.getContextPath()%>/adoptPet/addPetPhoto.do"
			...
			<div class="input-group mb-3">
				...
				<div class="form-file">
					<input id="isNew${AdoptPetVO.adopt_pet_no}" type="file" class="form-file-input form-control"
...
<script>
		$(`#isNew${AdoptPetVO.adopt_pet_no}`).on('change', function(e) {
			const file = this.files[0];

			const fr = new FileReader();
			fr.onload = function(e) {
				$(`#isNewPhoto${AdoptPetVO.adopt_pet_no}`).attr('src', e.target.result);
			};
