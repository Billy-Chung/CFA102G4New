...
%>
<%
	AdoptMemberNewsVo thisNews = (AdoptMemberNewsVo) request.getAttribute("thisNews");
%>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="row page-titles">
						<a
							href="<%=request.getContextPath()%>/back_end/adoptMember/adoptMemberNews.jsp"><button
								type="button" class="btn light btn-dark">
								回上一頁<span class="btn-icon-end"><i class="fa fa-star"></i></span>
							</button></a>
					</div>
					...
					<div class="col-xl-12 col-xxl-12">
						<div class="card">
							<div class="card-header">
								<h4 class="card-title">修改最新消息</h4>
							</div>

							<div class="card-body">
								<label class="col-sm-2 col-form-label col-form-label-lg">當前最新消息照片</label>
								<div class="col-sm-8 bottomSpace">
									<img
										src="<%=request.getContextPath()%>/adoptMeb/adoptMebNews.do?action=showNewsPhoto&PK=${thisNews.adopt_meb_news_no}"
										class="oldPhoto">
								</div>
								<div class="basic-form">
									...
									<form method="post"
										...
										<input type="hidden" name="adopt_meb_news_no"
											value="${thisNews.adopt_meb_news_no}"> <input
											type="hidden" name="requestURL"
											value="<%=request.getParameter("requestURL")%>">
										<!--接收原送出修改的來源網頁路徑後,再送給Controller準備轉交之用-->
										<input type="hidden" name="whichPage"
											value="<%=request.getParameter("whichPage")%>"> <input
											type="hidden" name="adopt_meb_no"
											value="${admin.adopt_meb_no}"> <input type="hidden"
											name="adopt_meb_news_state"
											value="${thisNews.adopt_meb_news_state}"> <input
										...
										<div class="mb-3 row">
											...
											<div class="col-sm-10">
												<input type="text" class="form-control form-control-lg"
													...
													value="<%=thisNews.getAdopt_meb_news_title()%>">
											</div>
										</div>
										...
										<div class="mb-3 row myright">
											<div class="col-sm-10">
												<button type="submit" class="btn light btn-secondary">修改最新消息</button>
											</div>
										</div>
									</form>
