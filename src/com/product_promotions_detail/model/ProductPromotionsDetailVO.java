...
public class ProductPromotionsDetailVO implements Serializable{
	...
	public Integer getProductSpecialPrice() {
		return productSpecialPrice;
	}
	public void setProductSpecialPrice(Integer productSpecialPrice) {
